...
{
    unsafe class Int32ArrayField_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(global::Int32ArrayField);
        ...
        {
            return ((global::Int32ArrayField)o).values;
        }

        static StackObject* CopyToStack_values_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((global::Int32ArrayField)o).values;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_values_0(ref object o, object v)
        {
            ((global::Int32ArrayField)o).values = (System.Collections.Generic.List<System.Int32>)v;
        }
        ...
        static StackObject* AssignFromStack_values_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            System.Collections.Generic.List<System.Int32> @values = (System.Collections.Generic.List<System.Int32>)typeof(System.Collections.Generic.List<System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ((global::Int32ArrayField)o).values = @values;
            return ptr_of_this_method;
        }

        static object get_fieldName_1(ref object o)
        {
            return ((global::Int32ArrayField)o).fieldName;
        }

        static StackObject* CopyToStack_fieldName_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((global::Int32ArrayField)o).fieldName;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_fieldName_1(ref object o, object v)
        {
            ((global::Int32ArrayField)o).fieldName = (System.String)v;
        }
        ...
        static StackObject* AssignFromStack_fieldName_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((global::Int32ArrayField)o).fieldName = @fieldName;
            return ptr_of_this_method;
        }
